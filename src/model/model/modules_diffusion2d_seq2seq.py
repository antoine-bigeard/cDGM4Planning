"""
Code adapted from `https://github.com/dome272/Diffusion-Models-pytorch`.
"""
...
class SelfAttention(nn.Module):
    def __init__(self, channels, len_seq, size):
    ...
    def forward(self, x):
        x = x.view(-1, self.channels, self.len_seq * self.size).swapaxes(1, 2)
        x_ln = self.ln(x)
