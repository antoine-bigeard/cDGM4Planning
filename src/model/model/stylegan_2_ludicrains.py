...
class Trainer:
    ...
    def train(self):
        ...
        apply_path_penalty = (
            not self.no_pl_reg and self.steps > 5000 and self.steps % 32 == 0
        )
    ...
    def calculate_fid(self, num_batches):
        ...
        for batch_num in tqdm(
            ...
            # moving averages
            generated_images = self.generate_truncated(
                self.GAN.SE, self.GAN.GE, latents, noise, trunc_psi=self.trunc_psi
            )
        ...
        return fid_score.calculate_fid_given_paths(
            [str(real_path), str(fake_path)], 256, noise.device, 2048
        )
